 ...
 * @author andy
 */
public class SSD1306 extends I2CDevice {
    ...
    public SSD1306(FF32c jiffy, int slaveAddr, Pin sclPin, Pin sdaPin, int bufferRows, int bufferCols, int rows, int cols) throws IOException, JiffyException, ArgumentException {
    ...
    public SSD1306(int slaveAddr, Pin sclPin, Pin sdaPin, int bufferRows, int bufferCols, int rows, int cols) throws IOException, JiffyException, ArgumentException {
